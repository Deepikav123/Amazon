export let oop = {
    cart: JSON.parse(localStorage.getItem('storage-oop')) || [
    ...
    store() {
        localStorage.setItem('storage-oop', JSON.stringify(this.cart));
    },
...
oop.store()
oop.addCart('77919bbe-0e56-475b-adde-4f24dfed3a04')
console.log(oop)
